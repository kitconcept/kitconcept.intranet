...
**Shadows:** `@kitconcept/volto-solr/components/theme/SolrSearch/SearchTabs` via `src/customizations/@kitconcept/volto-solr/components/theme/SolrSearch/SearchTabs.jsx`—the customization adds icons to each tab, which the upstream component doesn't have.
