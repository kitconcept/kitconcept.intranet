/**
 * OVERRIDE Toolbar.jsx
 * REASON: Add document review toolbar component and review sidebar.
 * FILE: https://github.com/plone/volto/blob/bec346595fb8884801c02a6ebf29fedc2bfe812e/packages/volto/src/components/manage/Toolbar/Toolbar.jsx
 * FILE VERSION: Volto 18.33.1
 * TICKET: https://gitlab.kitconcept.io/kitconcept/distribution-kitconcept-intranet/-/issues/216
 * DATE: 2026-04-21
...
let toolbarComponents = {
  ...
  'document-review': {
    ...
    wrapper: StandardWrapper,
    wrapperTitle: messages.documentReview,
    hideToolbarBody: true,
  },
  //END CUSTOMIZATION
};
...
class Toolbar extends Component {
  ...
  // START CUSTOMIZATION
  openReviewSidebar = (type) => {
    this.setState({ showReviewSidebar: true, reviewType: type });
  };
  // END CUSTOMIZATION
    ...
    return (
      this.props.token && (
        <>
                  ...
                  if (WrapperComponent) {
                    return (
                      <WrapperComponent
                        ...
                        //START CUSTOMIZATION
                        openReviewSidebar={this.openReviewSidebar}
                        //END CUSTOMIZATION
          ...
          {/* START CUSTOMIZATION */}
          {this.state.showReviewSidebar && (
            <ReviewSidebar
              review={this.state.reviewType}
              onClose={() =>
                this.setState({ showReviewSidebar: false, reviewType: null })
              }
            />
          )}
          {/* END CUSTOMIZATION */}
