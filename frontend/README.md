...
[![npm](https://img.shields.io/npm/v/@kitconcept/volto-intranet)](https://www.npmjs.com/package/@kitconcept/volto-intranet)
...
yo @plone/volto my-volto-project --addon @kitconcept/volto-intranet
cd my-volto-project
```

Add `@kitconcept/volto-intranet` to your package.json:
...
Add `@kitconcept/volto-intranet` to your `volto.config.js`:

```javascript
const addons = ['@kitconcept/volto-intranet'];
```

If this package provides a Volto theme, and you want to activate it, then add the following to your `volto.config.js`:

```javascript
const theme = '@kitconcept/volto-intranet';
```
