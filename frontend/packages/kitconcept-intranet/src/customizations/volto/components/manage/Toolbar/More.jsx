/**
 * OVERRIDE More.jsx
 * REASON: Add review plug.
 * FILE: https://github.com/plone/volto/blob/bec346595fb8884801c02a6ebf29fedc2bfe812e/packages/volto/src/components/manage/Toolbar/More.jsx
          ...
          >
            <li>
              <button
                ...
                onClick={() => push('document-review')}
                disabled={content.review_state !== 'published'}
              >
                <div>
                  <span className="pastanaga-menu-label">
